      ...
      slots.inject(
        ...
        () =>
          slots.inject('sidebar.workspaces.directoryFlow', function* () {
            yield slots.register({ name: 'conversation.hero.workspace.directoryFlow', id: 'dsh-remote', order: -100 }, RemoteDirectoryFlow)
            yield slots.register({ name: 'sidebar.workspaces.directoryFlow', id: 'dsh-remote', order: -100 }, RemoteDirectoryFlow)
          }),
      )
    }
