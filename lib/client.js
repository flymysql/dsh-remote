    ...
    function ensureChromeCss() {
      try {
        ...
        el.textContent = [
          ...
          '.dsh-rw-btn:disabled{opacity:.45;cursor:not-allowed}',
          ...
          '.dsh-rw-tab.is-active{background:var(--dsw-alias-button-primary-fill,#2563eb)!important;color:var(--dsw-alias-button-contrast-fill,#fff)!important;font-weight:600}',
