  ...
  factory: (require) => {
    ...
    function ensureChromeCss() {
      try {
        ...
        el.id = CHROME_CSS_ID
        el.textContent = [
          '.dsh-rw-btn{transition:background .12s ease,filter .12s ease,opacity .12s ease,border-color .12s ease}',
          '.dsh-rw-btn:hover:not(:disabled){filter:brightness(1.07);background:var(--dsw-alias-interactive-bg-hover,rgba(128,128,128,.14))}',
          ...
          '.dsh-rw-primary:hover:not(:disabled){filter:brightness(1.12);background:var(--dsw-alias-button-primary-fill,#2563eb)}',
          ...
          '.dsh-rw-row:hover{background:var(--dsw-alias-interactive-bg-hover,rgba(128,128,128,.10))}',
          '.dsh-rw-list-item{transition:background .1s ease}',
          '.dsh-rw-list-item:hover{background:var(--dsw-alias-interactive-bg-hover,rgba(128,128,128,.14))}',
          '.dsh-rw-tabs{display:inline-flex;padding:3px;gap:2px;border-radius:10px;background:var(--dsw-alias-interactive-bg-hover,rgba(128,128,128,.10));border:1px solid var(--dsw-alias-border-l2,rgba(128,128,128,.35))}',
